    ...
    public static class MiniDump
    {
...

        {
            ...
            if (exp.ExceptionPointers == IntPtr.Zero)
                bRet = MiniDumpWriteDump(currentProcessHandle, currentProcessId, fileHandle, (uint) options,
        ...
        //} MINIDUMP_EXCEPTION_INFORMATION, *PMINIDUMP_EXCEPTION_INFORMATION;s
